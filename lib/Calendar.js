...
var _jsxFileName = "/Users/guilherme/work/react-big-calendar/src/Calendar.js";
...
class Calendar extends _react.default.Component {
  constructor() {
    var _this;
    ...
    this.getViews = () => {
      ...
      if (Array.isArray(views)) {
        return (0, _transform.default)(views, (obj, name) => obj[name] = _Views.default[name], {});
      }

      if (typeof views === 'object') {
        return (0, _mapValues.default)(views, (value, key) => {
          if (value === true) {
  ...
  getContext(_ref2) {
    ...
    const msgs = (0, _messages.default)(messages);
    return {
      viewNames: names,
  ...
  render() {
    ...
    let CalToolbar = components.toolbar || _Toolbar.default;
