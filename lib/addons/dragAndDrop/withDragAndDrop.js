...
var _jsxFileName = "/Users/guilherme/work/react-big-calendar/src/addons/dragAndDrop/withDragAndDrop.js";
  ...
  class DragAndDropCalendar extends _react.default.Component {
    constructor() {
      ...
      this.handleInteractionStart = () => {
        if (this.state.interacting === false) this.setState({
          interacting: true
        });
      };
    ...
    render() {
      ...
      const interacting = this.state.interacting;
      delete props.onEventDrop;
      delete props.onEventResize;
      props.selectable = selectable ? 'ignoreEvents' : false;
      const elementPropsWithDropFromOutside = this.props.onDropFromOutside ? (0, _extends2.default)({}, elementProps, {
